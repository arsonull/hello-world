...
<body>
    <nav class="navbar navbar-dark navbar-expand-md bg-dark">
        ...
        <form action="/TogetherPeopleStrong/admin/updatePosting" method="POST">
            ...
            <input type="hidden" id="id" name="id" value="<?php echo e($posting[0]->getId()); ?>">
            <h2 class="text-center">Editing Job Posting</h2>
            <div class="form-group"><input class="form-control" type="text" id="posting_title" name="posting_title" placeholder="Title of the Job Posting" value="<?php echo e($posting[0]->getTitle()); ?>"></div><br/>
            <?php echo $errors->first('posting_title') ;?>
            <div class="form-group"><input class="form-control" type="text" id="skills" name="skills" placeholder="List of Skills" value="<?php echo e($posting[0]->getDesired_skills()); ?>"></div><br/>
            <?php echo $errors->first('skills');?>
            <div class="form-group"><textarea class="form-control" id="description" name="description" placeholder="Job Posting Description" rows="5" ><?php echo e($posting[0]->getDescription()); ?></textarea></div><br/>
...
</html><?php /**PATH C:\MAMP\htdocs\TogetherPeopleStrong\resources\views/edit_posting.blade.php ENDPATH**/ ?>