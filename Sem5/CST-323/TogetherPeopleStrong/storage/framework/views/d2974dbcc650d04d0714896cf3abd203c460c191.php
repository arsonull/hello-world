...
<body>
		<p><h1 class="display-1 text-center">Are you sure you would like to delete: <?php echo e($posting->getTitle()); ?> ?</h1></p>
		<div class="container">
          <div class="row">
            <div class="col-sm-2">
            </div>
...
</html><?php /**PATH C:\MAMP\htdocs\TogetherPeopleStrong\resources\views/DeleteConfirmation.blade.php ENDPATH**/ ?>